...
class LoopClosing;
class System;
class pointcloudmapping; //added for cloudMap
class Tracking
{

public:
    Tracking(shared_ptr<PointCloudMapping> pPointCloud,System* pSys, ORBVocabulary* pVoc, FrameDrawer* pFrameDrawer, MapDrawer* pMapDrawer, Map* pMap,
