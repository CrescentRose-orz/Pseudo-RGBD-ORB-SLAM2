...
PointCloudMapping::PointCloudMapping(double resolution)
{
    ...
    mocto_pub = mnh.advertise<octomap_msgs::Octomap>("orbslam2/octomap",10);
...
void PointCloudMapping::showPointCloud() 
{
    ...
    while(true) {   
        ...
        
        {
            ...
            //pcl::toROSMsg(mPointCloud->,tmpMsg);
            octomap::ColorOcTree tree( 0.01 ) tmpTree;
